import { footerMenuData } from 'Data/footer/footerMenuData';
                    ...
                    <div className='footer_bottom_left footer_info'>
                        <div className='footer_info_top'>
                            <span className='is-hidden-mobile'>
                                <Link to='/'>
                                    <svg width='85' id='icon_brand_logo' className='brand_logo' xmlns="http://www.w3.org/2000/svg"
                                    viewBox='0 0 433 90'>
                                        <path className='A'
                        ...
                        <div className='footer_info_bottom'>
                            ...
                            <div className='info-dropdown' style={{maxHeight:'54px'}}>
                                ...
                                <span>
                                    사업자번호: 499-81-00612
                                    <a href='http://www.ftc.go.kr/bizCommPop.do?wrkr_no=4998100612'>
                                        사업자 정보 확인
                                    </a>
                                </span>
                                <br/>
                                ...
                                <span>
                                    이메일
                                    <a href='mailto:info@inflearn.com'>
                                        {'info@inflearn.com'}
                                    </a>
                                </span>
                                <br/>
