...
function SignupSocial(props) {
    return (
        <div className='signup__social'>
            ...
            <span className='social__title'>간편 회원가입</span>
            <div className='social__signup-buttons'>
                <button className='social__button social__button--Kakao e-social-sign-up'>
                ...
                <button className='social__button social__button--Google e-social-sign-up'>
                    <svg width='18' xmlns="http://www.w3.org/2000/svg" height='18' viewBox="0 0 18 18">
