...
function CourseCard({linkSrc, imgSrc, ribbonCnt, courseTitle, instructor, rating, review, price, tags, level, group, use, isSale, saleText, delPrice, text}) {
            ...
            <div className='card course course_card_item'>
                ...
                <div className='course_card_back'>
                    <Link to={linkSrc} className='e_course_click'>
                        ...
                        <p className='course_description'>{text}</p>
