        ...
        <div className='container mobile_container'>
            <div className='content'>
                <div className='mobile_left'>
                    <span className='infd-icon e_lefd_aside_btn' datatype='open'>
                ...
                <div className='brand_header'>
                    <Link to='/' className="brand_logo">
                        ...
                        <svg width='10' id='icon_brand_logo' className='brand_logo' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 433 90">
                ...
                <div className='mobile_right'>
                    <Link role='button' className="button space-inset-4 text is-5 sighin">로그인</Link>
                    <Link className="e-signup button space-inset-4 text is-5 is-primary">회원가입</Link>
                </div>
            </div>
        </div>
    );
